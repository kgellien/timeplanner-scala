...
class ToDoDslSpec extends SpecificationWithJUnit {
  ...
  val mondaysWithBounds = """D1 =2012-04 !2012-04-16 mondays in april"""
  val mondaysWithBoundsExpected = """Task(D1,None,List(EqBound(2012-04), NeBound(2012-04-16)),mondays in april)"""
